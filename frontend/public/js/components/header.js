    ...
    function build() {
        ...
        el.innerHTML = `
            <div class="header-inner">
                <a href="/" data-route class="header-brand">
                    <span class="header-brand__glyph">⬡</span>
                    <span class="header-brand__name">requires.management</span>
                </a>

                <nav class="header-nav" id="header-nav">
                    <a href="/" class="nav-link nav-link--active" data-route>home</a>
                </nav>

                <div class="header-actions">
                    ${user ? renderUserRow(user) : renderLoginButton()}
                </div>
            </div>
        `;
...
function renderUserRow(user) {
    ...
    const avatarContent = user.avatar_url
        ...
        : `<span style="font-size:var(--font-tiny);color:var(--color-text-secondary);
